...
<body>
   ...
   <div class="form">
      ...
      <div class="icontainer i1">
        <input id="regno" name="estate_id"  class="input" value=<%=resultSet.getString("estate_id") %> type="text" placeholder=" " readonly/>
        <div class="cut"></div>
        <label for="regno" class="placeholder">estate_id</label>
      </div>
      <div class="icontainer i2">
        <input id="brand" name="location"  class="input" value=<%=resultSet.getString("location") %> type="text" placeholder=" " readonly/>
        <div class="cut"></div>
        <label for="brand" class="placeholder">location</label>
      </div>
      <div class="icontainer i2">
        <input id="year" name="construction"class="input"value=<%=resultSet.getString("construction") %> type="text" placeholder=" " readonly/>
        <div class="cut"></div>
        <label for="year" class="placeholder">construction</label>
      </div>
      <div class="icontainer i2">
        <input id="mileage" name="size" class="input" value=<%=resultSet.getString("size") %> type="text" placeholder=" " readonly/>
        <div class="cut cut-short"></div>
        <label for="mileage" class="placeholder">size</>
      </div>
          <div class="icontainer i2">
        <input id="oname" name="area" class="input" value=<%=resultSet.getString("area") %> type="text" placeholder=" " readonly/>
        <div class="cut cut-short"></div>
